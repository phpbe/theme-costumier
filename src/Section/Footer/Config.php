...
class Config
{
     ...
     *          \Be\Theme\Costumier\Section\Footer\Item\Image::class,
     *          \Be\Theme\Costumier\Section\Footer\Item\FollowUs::class,
     *          \Be\Theme\Costumier\Section\Footer\Item\Copyright::class,
     *          \Be\Theme\Costumier\Section\Footer\Item\Payments::class,
     *     ]"
     * )
     */
    public array $items = [
