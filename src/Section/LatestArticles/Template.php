...
class Template extends Section
{
    ...
    private function css()
    {
        ...
        echo $this->getCssPadding('latest-articles');
        echo $this->getCssMargin('latest-articles');

        echo '#' . $this->id . ' .latest-articles {';
        echo '}';


        echo '#' . $this->id . ' .latest-articles-inform-title {';
        ...
        echo '#' . $this->id . ' .latest-articles-inform-title:after {';
        echo 'content:\'\';';
        echo 'display: inline-block;';
        ...
        echo '#' . $this->id . ' .latest-articles-title {';
        ...
        echo '#' . $this->id . ' .latest-articles-link .be-btn {';
        echo 'position: relative;';
        echo '}';

        echo '#' . $this->id . ' .latest-articles-link .be-btn:after {';
        echo 'content:\'\';';
        echo 'display: inline-block;';
        echo 'position: absolute;';
        echo 'right: 3px;';
        ...
        echo '#' . $this->id . ' .latest-articles-small {';
        echo 'padding: 2rem;';
        echo 'background-color:  rgb(' . implode(' ', $rgbMinorColor) . ' / 2%);';
        echo 'border: #eee 1px solid;';
        echo '}';

        echo '#' . $this->id . ' .latest-articles-large,';
        echo '#' . $this->id . ' .latest-articles-small-image {';
        ...
        echo '#' . $this->id . ' .latest-articles-small-title a {';
        ...
        echo '#' . $this->id . ' .latest-articles-small-title a:hover {';
        echo 'color: var(--major-color);';
        echo '}';

        echo '#' . $this->id . ' .latest-articles-large-bottom {';
        echo 'position: absolute;';
        echo 'left: 2rem;';
        echo 'right: 2rem;';
        echo 'bottom: 2rem;';
        ...
        echo '#' . $this->id . ' .latest-articles-large-title a {';
        echo 'font-size: 1.25rem;';
        echo 'line-height: 1.5;';
        echo 'color: #fff;';
        echo 'font-family: "Rajdhani";';
        ...
        echo '#' . $this->id . ' .latest-articles-large-title a:hover {';
        echo 'color: var(--major-color);';
        echo '}';
    ...
    public function display()
    {
        ...
        echo '<div class="latest-articles-inform-title">';
        ...
        echo '<div class="latest-articles-title">';
        ...
        if ($this->config->linkText !== '' && $this->config->link !== '') {
            echo '<div class="latest-articles-link">';
        ...
        if ($this->config->layout === '5' && $count > 3) {
            ...
            echo '<div class="latest-articles-small">';
            ...
            foreach ($articles3 as $article) {
                ...
                echo '<div class="latest-articles-small-image" style="background-image: url(' . $article->image . ')"></div>';
                echo '</div>';

                echo '<div class="be-col">';
                echo '<div class="be-c-777">' . date('j M, Y', strtotime($article->publish_time)) . '</div>';
                echo '<div class="latest-articles-small-title">';
        ...
        foreach ($articles as $article) {
            ...
            echo '<div class="be-col-24 be-lg-col">';
            echo '<div class="latest-articles-large" style="background-image: url(' . $article->image . ')">';
            echo '<div class="latest-articles-large-bottom">';
            echo '<div class="latest-articles-large-title">';
            echo '<a class="be-t-ellipsis-2" href="' . beUrl('Cms.Article.detail', ['id' => $article->id]) . '" title="' . $article->title . '">';
            echo $article->title;
            echo '</a>';
            echo '</div>';
