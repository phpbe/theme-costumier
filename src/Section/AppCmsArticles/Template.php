...
namespace Be\Theme\Costumier\Section\AppCmsArticles;
                    ...
                    <div class="app-cms-articles-items">
                        ...
                        foreach ($this->page->result['rows'] as $article) {
                            ...
                            <div class="app-cms-articles-item">
                                ...
                                <div class="be-mt-150">
                                    <a class="be-btn be-btn-main be-btn-outline" href="<?php echo beUrl('Cms.Article.detail', ['id'=> $article->id]); ?>" title="<?php echo $article->title; ?>">Read more</a>
                                </div>
                            </div>
                            <?php
