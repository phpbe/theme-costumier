...
namespace Be\Theme\Costumier\Section\AppCmsArticleDetail;
        ...
        if ($this->config->enable) {
            ...
            <div class="be-mt-200 be-bt-eee be-pt-200">
                ...
                foreach ($this->page->article->tags as $tag) {
                    ?>
                    <a class="be-mt-50 be-ml-50 be-btn be-btn-main be-btn-sm" href="<?php echo beUrl('Cms.Article.search', ['tag'=> $tag]); ?>" title="<?php echo $tag; ?>">
                        #<?php echo $tag; ?>
                    </a>
                    <?php
                }
